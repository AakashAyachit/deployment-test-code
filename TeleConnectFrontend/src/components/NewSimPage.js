...
function NewSimPage() {
  ...
  const handleActivatePlan = async () => {
    ...
    try {
      await axios.post(
        `http://3.92.50.211:8083/api/user/plan/assign`,
        value,
        { withCredentials: true }
      );
      
      // Alert message after successful plan assignment
      alert('Mobile Number assigned successfully. Check your email for more details.');
